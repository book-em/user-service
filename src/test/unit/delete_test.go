...
func TestDelete_HostSuccess(t *testing.T) {
	svc, mockRepo, mockRoomClient, mockReservationClient := createTestService()
	...
	mockRoomClient.On("DeleteHostRooms", context.Background(), jwt).Return([]roomclient.RoomDTO{}, nil)
